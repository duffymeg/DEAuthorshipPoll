...
#uncomment one or both of the above lines if needed; need the github version of ggplot2 to deal with bar width problem down below
```
...
timeplot <- timedata %>%
  ...
  theme_bw() + 
  ggtitle("Number of authors of articles in first or second issue of journal, 1956-2016") +
  scale_x_discrete(breaks=c(1956,1966,1976,1986,1996,2006,2016)) +
  ylab("Number of authors")

timeplot

save_plot("timeplot.jpg", timeplot, base_width = 6, base_height = 4)
#note: this looks good within Rstudio but awful in the html file and in the saved jpg. Need to work on that, too.
```
...
twopanelplot <- ggdraw() +
  draw_plot(timecorrplotecol,0,0.5,1.0,0.5) +
  draw_plot(timecorrplotevol,0,0,1.0,0.5) 

twopanelplot

save_plot("twopanelplot.jpg", twopanelplot, base_width = 8, base_height = 6)
```
