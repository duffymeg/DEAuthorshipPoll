...
lastplotgrid4panel <- plot_grid(likert_92.mpg, likert_52.mpg, likert_42.mpg, likert_32.mpg,
                            labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2,
                            rel_widths = c(0.5, 0.5),
                            rel_heights = c(0.6, 0.4))

save_plot("lastplotgrid4panel.jpg", lastplotgrid4panel, base_width = 17, base_height = 8)
```
...
lastplotgrid2panel <- plot_grid(likert_72.mpg, likert_22.mpg, 
                            labels = c("A", "B"), ncol = 2, nrow = 1,
                            rel_widths = c(0.5, 0.5))

save_plot("lastplotgrid2panel.jpg", lastplotgrid2panel, base_width = 17, base_height = 5)
```
